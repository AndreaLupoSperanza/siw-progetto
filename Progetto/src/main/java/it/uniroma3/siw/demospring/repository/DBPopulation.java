...
public class DBPopulation implements ApplicationRunner{
	...
	private void addAll() throws InterruptedException {
		...
		/*Inizializzo Foto*/
		Foto 	f1 = fotoSet("Gatto1", this.albumRepository.findById((long) 1).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/010512d763d05b76f132b88ce3667695.jpg");
		Foto 	f2 = fotoSet("Gatto2", this.albumRepository.findById((long) 1).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/video-test-i-riflessi-di-sette-gattini-messi-alla-prova-1920x1080.jpg");
		Foto 	f3 = fotoSet("Gatto3", this.albumRepository.findById((long) 1).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/5t3YJQc.jpg");
		Foto	f4 = fotoSet("Gatto4", this.albumRepository.findById((long) 1).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/602_gattini-europei.jpg");
		Foto	f5 = fotoSet("Gatto5", this.albumRepository.findById((long) 1).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/A-D-2.jpg");
		Foto	f6 = fotoSet("Gatto6", this.albumRepository.findById((long) 1).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/BRITISH-2.jpg");
		Foto	f7 = fotoSet("Gatto7", this.albumRepository.findById((long) 1).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/C_2_fotogallery_3082838_19_image.jpg");
		Foto 	f8 = fotoSet("Gatto8", this.albumRepository.findById((long) 1).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/Collage_of_Six_Cats-02.jpg");
		Foto	f9 = fotoSet("Gatto9", this.albumRepository.findById((long) 1).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/aggressivitc3a0-verso-altri-gatti.png");
		Foto	f10 = fotoSet("Gatto10", this.albumRepository.findById((long) 2).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/bengala.jpg");
		Foto	f11 = fotoSet("Gatto11", this.albumRepository.findById((long) 2).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/cani-e-gatti-frasi-tra-pisa-e-firenze-mamma-lagottina.jpg");
		Foto	f12 = fotoSet("Gatto12", this.albumRepository.findById((long) 2).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/cat-1286572_1920.jpg");
		Foto	f13 = fotoSet("Gatto13", this.albumRepository.findById((long) 2).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/cat-1890606_1920.jpg");
		Foto	f14 = fotoSet("Gatto14", this.albumRepository.findById((long) 2).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/cistite-gatto.jpg");
		Foto	f15 = fotoSet("Gatto15", this.albumRepository.findById((long) 3).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/coppia-almo3.jpg");
		Foto	f16 = fotoSet("Gatto16", this.albumRepository.findById((long) 3).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/e0acc8b44039ed3bbb5e292455b8fc03.jpg");
		Foto	f17 = fotoSet("Gatto17", this.albumRepository.findById((long) 3).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/europeo.jpg");
		Foto	f18 = fotoSet("Gatto18", this.albumRepository.findById((long) 3).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/gatti_005.jpg");
		Foto	f19 = fotoSet("Gatto19", this.albumRepository.findById((long) 3).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/foto-50.jpg");
		Foto	f20 = fotoSet("Gatto20", this.albumRepository.findById((long) 4).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/gatti+(1).jpg");
		Foto	f21 = fotoSet("Gatto21", this.albumRepository.findById((long) 4).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/gatti+(2).jpg");
		Foto	f22 = fotoSet("Gatto22", this.albumRepository.findById((long) 4).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/gatti-che-si-accoppiano-e-abitudini-sessuali.jpg");
		Foto	f23 = fotoSet("Gatto23", this.albumRepository.findById((long) 4).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/gatti-incrociati-con-grossi-felini-1511792614.jpg");
		Foto	f24 = fotoSet("Gatto24", this.albumRepository.findById((long) 5).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/gatti-sbalorditivo-inconcepibile-segreto-2.jpg");
		Foto	f25 = fotoSet("Gatto25", this.albumRepository.findById((long) 5).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/gatti.jpg");
		Foto	f26 = fotoSet("Gatto26", this.albumRepository.findById((long) 5).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/gattini-in-una-riga-sfondo-1920x1080-28584_48.jpg");
		Foto	f27 = fotoSet("Gatto27", this.albumRepository.findById((long) 5).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/gatto-rosso.jpg");
		Foto	f28 = fotoSet("Gatto28", this.albumRepository.findById((long) 6).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/giuntinipet-home.png");
		Foto	f29 = fotoSet("Gatto29", this.albumRepository.findById((long) 6).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/images+(1).jpg");
		Foto	f30 = fotoSet("Gatto30", this.albumRepository.findById((long) 6).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/images.jpg");
		Foto	f31 = fotoSet("Gatto31", this.albumRepository.findById((long) 7).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/gatti_001.jpg");
		Foto	f32 = fotoSet("Gatto32", this.albumRepository.findById((long) 7).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/img_2933-1.jpg");
		Foto	f33 = fotoSet("Gatto33", this.albumRepository.findById((long) 7).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/kittens-1700474_1920.jpg");
		Foto	f34 = fotoSet("Gatto34", this.albumRepository.findById((long) 7).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/mondogatti-1.jpg");
		Foto	f35 = fotoSet("Gatto35", this.albumRepository.findById((long) 7).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/nomi-per-gatti-neri.jpg");
		Foto	f36 = fotoSet("Gatto36", this.albumRepository.findById((long) 7).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/regalo-gattini.jpg");
		Foto	f37 = fotoSet("Gatto37", this.albumRepository.findById((long) 8).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/slide1.jpg");
		Foto	f38 = fotoSet("Gatto38", this.albumRepository.findById((long) 8).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/the-four.jpg");
		Foto	f39 = fotoSet("Gatto39", this.albumRepository.findById((long) 8).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/video-di-gattini.jpg");
		Foto	f40 = fotoSet("Gatto40", this.albumRepository.findById((long) 9).get(), "https://s3.eu-central-1.amazonaws.com/it.siw.uniroma3.cuomo/video-test-i-riflessi-di-sette-gattini-messi-alla-prova-1920x1080.jpg");
